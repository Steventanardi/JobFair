...
const I18N = {
  ...
  translations: {
    ...
    'empDash.eventInfo': { en: 'Event Information', zh: '活動資訊' },
    'empDash.yourAccount': { en: 'Your Account', zh: '您的帳號' },
    'empDash.accountBtn': { en: 'Account', zh: '帳號' },
    'empDash.accountSettings': { en: 'Account Settings', zh: '帳號設定' },
    'empDash.changePw': { en: 'Change Password', zh: '更改密碼' },
    'empDash.currentPw': { en: 'Current Password', zh: '目前密碼' },
    'empDash.newPw': { en: 'New Password', zh: '新密碼' },
    'empDash.confirmNewPw': { en: 'Confirm New Password', zh: '確認新密碼' },
    'empDash.changePwBtn': { en: 'Change Password', zh: '更改密碼' },
    'empDash.subDetails': { en: 'Submission Details', zh: '報名詳情' },
    'empDash.eventDate': { en: 'Date', zh: '日期' },
    'empDash.eventVenue': { en: 'Venue', zh: '地點' },
    'empDash.eventDeadline': { en: 'Deadline', zh: '截止日期' },
    'empDash.eventEmail': { en: 'Email', zh: '電子信箱' },
    'empDash.eventPhone': { en: 'Phone', zh: '電話' },
    'empDash.eventComingSoon': { en: 'Event details coming soon.', zh: '活動詳情即將公佈。' },
    'empDash.stepSubmitted': { en: 'Submitted', zh: '已提交' },
    'empDash.stepReviewing': { en: 'Reviewing', zh: '審核中' },
    'empDash.stepApproved': { en: 'Approved', zh: '已通過' },
    'empDash.stepRejected': { en: 'Rejected', zh: '已拒絕' },
    'empDash.assignedBooth': { en: 'Assigned Booth', zh: '已分配攤位' },
    'empDash.rejectTitle': { en: '✕ Submission Not Selected', zh: '✕ 報名未通過' },
    'empDash.rejectContact': { en: 'Please contact the event organizer if you have questions about re-applying.', zh: '如有關於重新申請的問題，請聯繫活動主辦單位。' },
    'empDash.adminNoteLabel': { en: 'Admin Note:', zh: '管理備註：' },
    'empDash.viewDetails': { en: 'View All Details', zh: '查看完整詳情' },
    'empDash.printConfirm': { en: 'Print Confirmation', zh: '列印確認書' },
    'empDash.changePwAccount': { en: '🔑 Change Password', zh: '🔑 更改密碼' },
    'empDash.noSubsTextFull': { en: 'Submit your registration to participate in the NQU Job Fair. Fill in your company details, job positions, and booth preferences.', zh: '提交報名資料以參加金大徵才博覽會。填寫公司資料、職缺及攤位偏好。' },
    'empDash.createSub': { en: '+ Create Submission', zh: '+ 建立報名' },
    'empDash.errorLoad': { en: 'Error loading submission', zh: '載入報名資料失敗' },
    'empDash.retry': { en: 'Retry', zh: '重試' },
    'empDash.submittedOn': { en: 'Submitted', zh: '已提交' },
    'empDash.fieldContact': { en: 'Contact', zh: '聯絡人' },
    'empDash.allFieldsRequired': { en: 'All fields are required', zh: '請填寫所有欄位' },
    'empDash.pwChanged': { en: 'Password changed successfully', zh: '密碼已更新！' },
    'empDash.detailCompany': { en: 'Company Information', zh: '公司資料' },
    'empDash.detailContact': { en: 'Contact', zh: '聯絡資訊' },
    'empDash.detailRegDetails': { en: 'Registration Details', zh: '報名資訊' },
    'empDash.detailRecruitment': { en: 'Recruitment Info', zh: '招募資訊' },
    'empDash.detailLogistics': { en: 'Event Day Logistics', zh: '活動當日事務' },
    'empDash.detailCeo': { en: 'CEO / Responsible Person', zh: '負責人' },
    'empDash.mainProducts': { en: 'Main Products / Services', zh: '主要產品/業務' },
    'empDash.estDate': { en: 'Establishment Date', zh: '成立日期' },
    'empDash.groupType': { en: 'Group Type', zh: '團體類型' },
    'empDash.detailContactPerson': { en: 'Contact Person', zh: '聯絡人' },
    'empDash.phone': { en: 'Phone', zh: '電話' },
    'empDash.companyIntro': { en: 'Company Introduction', zh: '公司簡介' },
    'empDash.requirements': { en: 'Requirements', zh: '應徵條件' },
    'empDash.benefits': { en: 'Benefits', zh: '福利待遇' },
    'empDash.leadAttendee': { en: 'Lead Attendee', zh: '主要負責人' },
    'empDash.presentationRoom': { en: 'Needs Presentation Room', zh: '需要簡報室' },
    'empDash.shuttle': { en: 'Needs Shuttle', zh: '需要接駁車' },
    'empDash.shuttleDetails': { en: 'Shuttle Details', zh: '接駁詳情' },
    'empDash.boothNumber': { en: 'Booth Number', zh: '攤位編號' },
    'empDash.reviewedOn': { en: 'Reviewed', zh: '審核時間' },
    'empDash.printTitle': { en: 'NQU Job Fair — Booth Confirmation', zh: 'NQU 徵才博覽會 — 攤位確認書' },
    'empDash.printSubtitle': { en: 'This document confirms your registration for the National Quemoy University Job Fair.', zh: '本文件確認貴單位已成功報名國立金門大學徵才博覽會。' },
    'empDash.printBoothLabel': { en: 'Your Booth Number', zh: '您的攤位編號' },
    'empDash.printNotes': { en: 'Notes from Organizer', zh: '主辦單位備註' },
    'empDash.printApproved': { en: 'APPROVED ✓', zh: '已通過 ✓' },

    // ── Submit form — editing blocked / draft ─────────────────
    'submit.editBlocked': { en: 'Editing Not Available', zh: '無法編輯' },
    'submit.editBlockedMsg': { en: 'This submission has been', zh: '此報名已被' },
    'submit.editBlockedSuffix': { en: 'and can no longer be edited.', zh: '，無法再編輯。' },
    'submit.backDash': { en: 'Back to Dashboard', zh: '返回控制台' },
    'submit.draftFound': { en: '📝 A saved draft was found. Restore it?', zh: '📝 找到已儲存的草稿，是否還原？' },
    ...
    'adm.changePw': { en: 'Change Admin Password', zh: '更改管理員密碼' },
    'adm.currentPw': { en: 'Current Password', zh: '目前密碼' },
    'adm.newPwLabel': { en: 'New Password', zh: '新密碼' },
    'adm.confirmNewPw': { en: 'Confirm New Password', zh: '確認新密碼' },
    'adm.updatePw': { en: 'Update Password', zh: '更新密碼' },
    'adm.adminAccounts': { en: 'Admin Accounts', zh: '管理員帳號' },
    'adm.addAdmin': { en: '+ Add Admin', zh: '+ 新增管理員' },
    'adm.addAdminTitle': { en: 'Add Admin Account', zh: '新增管理員帳號' },
    ...
    'submit.sectionParticipation': { en: 'Participation Info',     zh: '報名資訊' },
    'submit.activityCategory':     { en: 'Activity Category',      zh: '活動類別' },
    'submit.prevPartic':           { en: 'Previous Participant',    zh: '曾參加過' },
    'submit.sectionCompany':       { en: 'Company / Organization',  zh: '單位基本資料' },
    'submit.companyName':          { en: 'Company Name',            zh: '公司名稱' },
    'submit.boothSignName':        { en: 'Booth Signboard Name',    zh: '攤位看板名稱' },
    'submit.ceoName':              { en: 'Responsible Person',      zh: '負責人' },
    'submit.taxId':                { en: 'Business Reg. No.',       zh: '統一編號' },
    'submit.industry':             { en: 'Industry',                zh: '產業類型' },
    'submit.mailingAddress':       { en: 'Mailing Address',         zh: '通訊地址' },
    'submit.sectionStrategy':      { en: 'Recruitment Details',     zh: '招募資訊' },
    'submit.internship':           { en: 'Internship Cooperation',  zh: '實習合作' },
    'submit.targetDepts':          { en: 'Target Departments',      zh: '目標系所' },
    'submit.jobPositions':         { en: 'Job Positions',           zh: '職缺說明' },
    'submit.sectionLogistics':     { en: 'Event Logistics',         zh: '活動庶務' },
    'submit.attendeeCount':        { en: 'Attendees',               zh: '出席人數' },
    'submit.lunchNonVeg':          { en: 'Lunch (Regular)',         zh: '葷食便當' },
    'submit.lunchVeg':             { en: 'Lunch (Veg)',             zh: '素食便當' },
    'submit.parking':              { en: 'Parking Spaces',          zh: '停車位' },
    'submit.rafflePrizes':         { en: 'Raffle Prizes',           zh: '抽獎獎品' },
    'submit.otherReq':             { en: 'Other Requirements',      zh: '其他需求' },
    'adm.status':                  { en: 'Status',                  zh: '狀態' },

    // ── CMS Translations ─────────────────────────────────────
    'cms.title': { en: 'Content Management System', zh: '內容管理系統' },
    'cms.pages': { en: 'Pages', zh: '頁面' },
    'cms.media': { en: 'Media', zh: '媒體庫' },
    'cms.navigation': { en: 'Navigation', zh: '導航菜單' },
    'cms.settings': { en: 'Settings', zh: '設定' },
    'cms.back': { en: 'Back to Admin', zh: '返回管理面板' },
    'cms.loading': { en: 'Loading...', zh: '載入中...' },
    'cms.noPages': { en: 'No pages yet', zh: '尚無頁面' },
    'cms.noMedia': { en: 'No media files yet', zh: '尚無媒體檔案' },
    'cms.noNav': { en: 'No navigation items', zh: '尚無導航項目' },
    'cms.newPage': { en: '+ New Page', zh: '+ 新增頁面' },
    'cms.editPage': { en: 'Edit Page', zh: '編輯頁面' },
    'cms.uploadMedia': { en: '+ Upload File', zh: '+ 上傳檔案' },
    'cms.newNav': { en: '+ Add Link', zh: '+ 新增連結' },
    'cms.editNav': { en: 'Edit Link', zh: '編輯連結' },
    'cms.edit': { en: 'Edit', zh: '編輯' },
    'cms.delete': { en: 'Delete', zh: '刪除' },
    'cms.copy': { en: 'Copy URL', zh: '複製網址' },
    'cms.slug': { en: 'Slug', zh: '網址代碼' },
    'cms.pageTitle': { en: 'Page Title', zh: '頁面標題' },
    'cms.content': { en: 'Content (HTML)', zh: '內容 (HTML)' },
    'cms.metaTitle': { en: 'Meta Title', zh: 'Meta 標題' },
    'cms.metaDesc': { en: 'Meta Description', zh: 'Meta 描述' },
    'cms.sortOrder': { en: 'Sort Order', zh: '排序' },
    'cms.active': { en: 'Active', zh: '啟用' },
    'cms.label': { en: 'Label', zh: '標籤' },
    'cms.url': { en: 'URL', zh: '網址' },
    'cms.icon': { en: 'Icon (emoji)', zh: '圖示 (emoji)' },
    'cms.position': { en: 'Position', zh: '位置' },
    'cms.parentPage': { en: 'Parent Page', zh: '上層頁面' },
    'cms.newTab': { en: 'Open in new tab', zh: '在新分頁開啟' },
    'cms.confirmDelPage': { en: 'Delete this page?', zh: '確認刪除此頁面？' },
    'cms.confirmDelMedia': { en: 'Delete this file?', zh: '確認刪除此檔案？' },
    'cms.confirmDelNav': { en: 'Delete this link?', zh: '確認刪除此連結？' },
    'cms.groupGeneral': { en: 'General Settings', zh: '一般設定' },
    'cms.groupEvent': { en: 'Event Information', zh: '活動資訊' },
    'cms.groupContact': { en: 'Contact Information', zh: '聯絡資訊' },
    'cms.groupSocial': { en: 'Social Links', zh: '社群連結' },
    'cms.groupBranding': { en: 'Branding', zh: '品牌形象' },
    'cms.siteName': { en: 'Site Name', zh: '網站名稱' },
    'cms.siteTagline': { en: 'Tagline', zh: '標語' },
    'cms.eventDate': { en: 'Event Date', zh: '活動日期' },
    'cms.eventVenue': { en: 'Venue', zh: '活動地點' },
    'cms.regDeadline': { en: 'Registration Deadline', zh: '報名截止' },
    'cms.contactEmail': { en: 'Email', zh: '電子信箱' },
    'cms.contactPhone': { en: 'Phone', zh: '電話' },
    'cms.logoUrl': { en: 'Logo URL', zh: 'Logo 網址' },
    'cms.faviconUrl': { en: 'Favicon URL', zh: 'Favicon 網址' },
    'cms.saveSettings': { en: 'Save Settings', zh: '儲存設定' },

    // ── CMS Messages ────────────────────────────────────────────
    'msg.pageCreated': { en: 'Page created!', zh: '頁面已建立！' },
    'msg.pageUpdated': { en: 'Page updated!', zh: '頁面已更新！' },
    'msg.pageDeleted': { en: 'Page deleted', zh: '頁面已刪除' },
    'msg.mediaDeleted': { en: 'File deleted', zh: '檔案已刪除' },
    'msg.navCreated': { en: 'Link created!', zh: '連結已建立！' },
    'msg.navUpdated': { en: 'Link updated!', zh: '連結已更新！' },
    'msg.navDeleted': { en: 'Link deleted', zh: '連結已刪除' },
    'msg.cmsSaved': { en: 'CMS settings saved!', zh: 'CMS 設定已儲存！' },
    'msg.uploaded': { en: 'File uploaded!', zh: '檔案已上傳！' },
    'msg.copied': { en: 'URL copied!', zh: '網址已複製！' },
  ...
  setLang(lang) {
    ...
    // Notify pages that re-render dynamic content
