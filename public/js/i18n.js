...
const I18N = {
  ...
  translations: {
    ...
    // ── Detailed Submission Fields ────────────────────────
    'submit.eventPart': { en: 'Event Participation', zh: '活動報名資訊' },
    'submit.activityCategory': { en: 'Activity Category', zh: '活動類別' },
    'submit.actRecruit': { en: 'On-site Recruitment', zh: '現場徵才(含企業說明會、職缺面試)' },
    'submit.actResume': { en: 'Resume Collection', zh: '代收履歷(不派員到校，僅由本校代收)' },
    'submit.actPromo': { en: 'Public Welfare Promotion', zh: '現場公益、職訓、創業宣導' },
    'submit.isPrev': { en: 'Previously Participated?', zh: '是否曾參加過金大徵才博覽會？' },
    'submit.boothName': { en: 'Booth Signboard Name', zh: '攤位招牌全銜' },
    'submit.ceoName': { en: 'CEO/Principal Name', zh: '負責人姓名' },
    'submit.taxId': { en: 'Tax ID (Unified No.)', zh: '統一編號' },
    'submit.mainProducts': { en: 'Main Products/Business', zh: '主要產品/服務' },
    'submit.internship': { en: 'Internship Cooperation', zh: '是否與本校有實習合作' },
    'submit.targetDeps': { en: 'Target Departments', zh: '招募/宣導對象系所' },
    'submit.mailingAddr': { en: 'Mailing Address', zh: '通訊地址' },
    'submit.attendeeInfo': { en: 'Attendee Information', zh: '活動出席人員(聯絡人以外)' },
    'submit.attendeeName': { en: 'Name', zh: '姓名' },
    'submit.attendeeTitle': { en: 'Title', zh: '職稱' },
    'submit.attendeePhone': { en: 'Mobile', zh: '手機' },
    'submit.totalAttendees': { en: 'Total Attendees', zh: '活動當天預計出席人數(含聯絡人)' },
    'submit.lunchBoxes': { en: 'Lunch Box Needs', zh: '便當、茶飲需求' },
    'submit.lunchNonVeg': { en: 'Non-Veg', zh: '葷食' },
    'submit.lunchVeg': { en: 'Veg', zh: '素食' },
    'submit.lunchHint': { en: 'Total max 3 per company', zh: '每間公司上限3份' },
    'submit.presentation': { en: 'Presentation Need', zh: '是否有企業說明會/宣導需求' },
    'submit.shuttle': { en: 'Shuttle Service Need', zh: '接駁校園需求(往返機場/水頭)' },
    'submit.raffle': { en: 'Raffle Prizes', zh: '摸彩活動獎品(自由提供)' },
    'submit.parking': { en: 'Parking Spaces Needed', zh: '車位需求數量' },
    'submit.otherReq': { en: 'Other Requirements', zh: '其他需求或備註' },
    'submit.resumeConfirm': { en: 'Resume Collection Agreement', zh: '代收履歷同意書' },
    'submit.agree': { en: 'I agree', zh: '我同意' },

    // ── NQU Departments ───────────────────────────────────
    'dep.all': { en: 'All Departments', zh: '全校不限系所' },
    'dep.humanities': { en: 'Humanities & Arts', zh: '人文藝術學院' },
    'dep.management': { en: 'Management', zh: '管理學院' },
    'dep.scieng': { en: 'Science & Engineering', zh: '理工學院' },
    'dep.social': { en: 'Social Sciences', zh: '社會科學院' },
    'dep.health': { en: 'Health & Nursing', zh: '健康護理學院' },
