...
const I18N = {
  ...
  translations: {
    ...
    'msg.settingsSaved': { en: 'Settings saved!', zh: '設定已儲存！' },
    'empLogin.forgot': { en: 'Forgot your password?', zh: '忘記密碼？' },
    'empLogin.forgotTip': { en: 'Contact the admin to reset it.', zh: '請聯繫管理員重設密碼。' },
    'adm.settings': { en: 'Settings', zh: '設定' },
    'adm.settingsTitle': { en: 'Event Settings', zh: '活動設定' },
    'adm.settingsDesc': { en: 'These values are displayed on the main page. Update them for each event period.', zh: '以下資訊將顯示於首頁，請於每次活動前更新。' },
    'adm.settingDateEN': { en: 'Event Date (EN)', zh: '活動日期（英文）' },
    'adm.settingDateZH': { en: 'Event Date (中文)', zh: '活動日期（中文）' },
    'adm.settingDeadlineEN': { en: 'Registration Deadline (EN)', zh: '報名截止日（英文）' },
    'adm.settingDeadlineZH': { en: 'Registration Deadline (中文)', zh: '報名截止日（中文）' },
    'adm.settingVenueEN': { en: 'Venue (EN)', zh: '活動地點（英文）' },
    'adm.settingVenueZH': { en: 'Venue (中文)', zh: '活動地點（中文）' },
    'adm.saveSettings': { en: 'Save Settings', zh: '儲存設定' },
